...
const EditProductPage = () => {
  ...
  const removeImage = (index) => {
    ...
    if (!newImagePreviewUrls[index].includes('blob') && !newImagePreviewUrls[index].includes('http')) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-teal-600 to-emerald-600 px-6 py-5">
            ...
            <p className="text-teal-100 text-sm mt-1">Update your product information</p>
          </div>
